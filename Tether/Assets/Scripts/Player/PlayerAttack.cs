...
namespace Tether.Player
{
    public class PlayerAttack : MonoBehaviour
    {
        ...
        [SerializeField] private Vector2 _hitboxSize = new Vector2(2.2f, 2.6f);
        [SerializeField] private Vector2 _hitboxOffset = new Vector2(1.6f, 0f);
